    ...
    <div>
      ...
      <Navigation />
        <div className="container-fluid pad">
            ...
            <div className="row">
                <div class="card c" style={{width: '400px', marginLeft:'auto',marginRight:'auto',marginTop:'2%'}}>
                    <div class="card-body">
                    <h6 class="card-text" style={{color : 'whitesmoke'}}>
                        <ul>
<a href={x.link} target="_blank" rel="noopener noreferrer" style={{color : 'white'}}>


    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="whatsapp" viewBox="0 0 16 16" >
